...
from app.routes.web.entries.handlers import (
    EntryNotFoundError,
...
async def get_entry_edit_form_response(
    ...
    return templates.TemplateResponse(
        request=request,
        name="components/entries/entry_edit_form.html.jinja2",
        context={
...
def get_entry_delete_confirm_response(
    ...
    return templates.TemplateResponse(
        request=request,
        name="components/entries/entry_delete_confirm.html.jinja2",
