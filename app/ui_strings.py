...
ACTIVITY_FORM_NAME_PLACEHOLDER = "e.g. Workout (2-20 characters)"
ACTIVITY_FORM_NAME_TOO_SHORT = "Activity name must be at least 2 characters."
ACTIVITY_FORM_NAME_TOO_LONG = "Activity name must be at most 20 characters."
...
STATS_AVERAGE_WEEKLY_LABEL = "weekly"
STATS_AVERAGE_MONTHLY_LABEL = "monthly"
...
TAG_FILTER_ENTRY_COUNT = "{count} entries"
...
HISTORY_MONTH_ENTRY_COUNT_ONE = "{count} entry"
HISTORY_MONTH_ENTRY_COUNT = "{count} entries"
HISTORY_CLEAR_SELECTION = "Clear selection"
HISTORY_ADD_ENTRY = "Add entry"
...
SOCIAL_FEED_FILTER_LABEL = "Recent entries filter"
SOCIAL_FEED_FILTER_PUBLIC = "Public"
SOCIAL_FEED_FILTER_FELLOWS = "Fellows"
SOCIAL_FEED_WINDOW_EMPTY = "No entries in the last 30 days."
SOCIAL_FEED_WINDOW_FOOTER = "Entries from the last 30 days."
SOCIAL_FEED_LOADING_ARIA = "Loading more recent entries"
...
COMMENTS_HIDE = "Hide"
COMMENTS_UNHIDE = "Unhide"
COMMENTS_REPLY = "Reply"
COMMENTS_REPLY_ARIA = "Reply to {author}"
COMMENTS_REPLYING_TO = "Replying to @{author}"
COMMENTS_REPLY_BODY_LABEL = "Write a reply to {author}"
COMMENTS_REPLY_BODY_PLACEHOLDER = "Write a reply"
...
COMMENTS_HIDDEN_BY_USER = "Hidden by {username}"
...
NOTIFICATIONS_COMMENT_TEXT_WITH_PREVIEW = "{actor} commented on your {activity} entry: “{preview}”"
NOTIFICATIONS_COMMENT_REPLY_TEXT = "{actor} left a new reply to your comment."
NOTIFICATIONS_COMMENT_REPLY_TEXT_WITH_PREVIEW = "{actor} left a new reply to your comment: “{preview}”"
NOTIFICATIONS_COMMENT_REPLY_PARTICIPANT_TEXT = "{actor} replied to a comment you joined."
NOTIFICATIONS_COMMENT_REPLY_PARTICIPANT_TEXT_WITH_PREVIEW = "{actor} replied to a comment you joined: “{preview}”"
...
META_TITLE_PROFILE_PUBLIC = "{username} · Mushin"
META_TITLE_ACTIVITY_PUBLIC = "{activity} · {username} · Mushin"
META_DESCRIPTION_PROFILE_PUBLIC = "{username} tracks {activity_count} public activities on Mushin."
...
ACTIVITY_CREATED = "Activity created {date}"
ACTIVITY_RECORDS_FROM = "Records from {date}"
SCHEMA_PUBLIC_ACTIVITIES = "Public activities"
SCHEMA_FELLOWS = "Fellows"
SCHEMA_CURRENT_TOTAL = "Current total"
SCHEMA_CURRENT_STREAK = "Current streak"
