...
PUBLIC_ACTIVITY_SUMMARY = "{username} is tracking {activity}. Current total: {total}."
PUBLIC_ACTIVITY_SUMMARY_STREAK = "Current streak: {streak} days."
PUBLIC_ACTIVITY_SUMMARY_RANGE = "Recorded from {start} to {end}."
